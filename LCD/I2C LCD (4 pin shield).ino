...
/*
* Code for an LCD wiht a 4 pin I2C shield (for more in depth on the LCD veiw Basic LCD)
...
LiquidCrystal_I2C lcd(0x27, 16, 2); //  (refer to the link above for info on how to get the adress) 
